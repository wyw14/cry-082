...
FROM alpine:3.21
ENV FILE_ROOT=/var/lib/dust/files
RUN apk add --no-cache tzdata && addgroup -S app && adduser -S -G app -u 10001 app && mkdir -p /var/lib/dust/files && chown -R app:app /var/lib/dust
