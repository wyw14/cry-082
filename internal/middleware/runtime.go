...
const responseCorrelationKey = "response_correlation_id"
...
func ResponseMetadataFor(c *gin.Context) ResponseMetadata {
	value, _ := c.Get(responseCorrelationKey)
	...
	return ResponseMetadata{RequestID: requestID, Route: route, Method: method}
}
