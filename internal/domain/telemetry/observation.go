...
func (o Observation) SeriesIdentity() SeriesIdentity {
	return SeriesIdentity{SiteID: o.SiteID, PointID: o.PointID, Metric: o.Metric}
}

func (s SeriesIdentity) Valid() bool {
	...
	return strings.TrimSpace(s.SiteID) != "" && strings.TrimSpace(s.PointID) != "" && supported[s.Metric]
}

func (s SeriesIdentity) Key() (string, error) {
	if !s.Valid() {
